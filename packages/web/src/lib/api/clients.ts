...
import type { ApiResponse, ApiListResponse, Client, ClientCreate, ClientUpdate, ClientStatsData } from '@freelancebill/shared';
...
export async function getClientStats(id: string) {
  return fetchApi<ApiResponse<ClientStatsData>>(`/api/clients/${id}/stats`);
}
